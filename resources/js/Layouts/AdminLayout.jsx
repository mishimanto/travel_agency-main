...
export default function AdminLayout({ title, children }) {
    ...
    const navigation = [
        ...
        { name: 'Reports', href: route('admin.reports'), icon: ChartBarIcon, routeName: 'admin.reports' },
                                        ...
                                        <Menu.Item>
                                            {({ active }) => (
                                                <Link
                                                    ...
                                                    className={`${
                                                        active ? 'bg-gray-50' : ''
                                                    } flex w-full items-center gap-x-2 px-4 py-2.5 text-sm text-gray-700 transition-colors duration-150`}
                                                >
