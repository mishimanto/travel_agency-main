                    ...
                    <div className="lg:col-span-2">
                        ...
                        <div className="mb-8 rounded-xl overflow-hidden shadow-lg">
                            {hasImage ? (
                                ...
                                <div className={`h-96 ${getImageUrl()} flex items-center justify-center`}>
                                    <div className="text-center">
                                        <span className="text-white text-2xl font-bold block mb-2">{pkg.title}</span>
                                        <span className="text-white/80">
                                            {pkg.destination?.name || 'Amazing Destination'}
                                        </span>
                            ...
                            <form onSubmit={handleSubmit}>
                                ...
                                <div className="mb-6 bg-gray-50 p-4 rounded-lg">
                                    <div className="flex justify-between mb-2">
                                        <span className="text-gray-600">${pkg.price} × {travelers} people</span>
                                    ...
                                    <div className="border-t pt-2 mt-2">
                                        <div className="flex justify-between">
                                            ...
                                            <span className="text-2xl font-bold text-indigo-600">${(totalPrice + 49.99).toFixed(2)}</span>
                                        </div>
                                    </div>
                                </div>
