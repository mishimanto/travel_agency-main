...
class SettingsController extends Controller
{
    ...
    private function updateSiteSettings(Request $request)
    {
        ...
        if ($request->hasFile('logo')) {
            ...
            $validated['logo'] = '/images/logo.png';
        } else {
        ...
        if ($request->hasFile('favicon')) {
            ...
            $validated['favicon'] = '/images/favicon.ico';
        } else {
        ...
        if (!isset($validated['enable_registration'])) {
            $validated['enable_registration'] = false;
        }
        
        if (!isset($validated['enable_booking'])) {
            $validated['enable_booking'] = false;
        }
    ...
    private function updatePaymentSettings(Request $request)
    {
        ...
        if (!isset($validated['enable_stripe'])) {
            $validated['enable_stripe'] = false;
        }
        
        if (!isset($validated['enable_paypal'])) {
            $validated['enable_paypal'] = false;
        }
        
        if (!isset($validated['enable_bank_transfer'])) {
            $validated['enable_bank_transfer'] = false;
        }
    ...
    private function updateSocialSettings(Request $request)
    {
        ...
        if (!isset($validated['enable_sharing'])) {
            $validated['enable_sharing'] = false;
        }
    ...
    private function updateSeoSettings(Request $request)
    {
        ...
        } elseif ($request->has('remove_og_image') && $request->remove_og_image) {
            $validated['og_image'] = '/images/og-image.jpg';
        } else {
            unset($validated['og_image']);
        }
        
        if (!isset($validated['enable_sitemap'])) {
            $validated['enable_sitemap'] = false;
        }
